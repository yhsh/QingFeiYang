...
public class CityFragment extends BaseHomeFragment {
    int num = 10;//默认10条笑话
    int page = 1;
...
//            dingyue_list.setAdapter(new ArrayAdapter<>(getActivity(), android.R.layout.simple_gallery_item, head_hair_quest));
    ...
    private void initNetworkData(int number) {
        ...
        GetNetworkJsonData.TakeNetworkData(YhshAPI.JOKE + number, handler, 0, pd, getActivity(), "UTF-8");
    }
    ...
    private class MyBaseAdapter extends BaseAdapter {
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            viewHolder.dingyue_list_item_request.setText("标题：" + head_hair_title.get(i));
